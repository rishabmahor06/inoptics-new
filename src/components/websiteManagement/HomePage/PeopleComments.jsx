...
export default function PeopleComments() {
  ...
  return (
    <div className="space-y-4">
      ...
      <WmTable
        headers={["ID", "PHOTO", "COMMENT", "NAME", "DESIGNATION", "ACTIONS"]}
        loading={loading}
      ...
      {modal && (
        <WmModal
          title={modal === "add" ? "Add Comment" : "Edit Comment"}
        ...
        >
          <div className="space-y-4">
            ...
            <Field
              label={modal === "edit" ? "Replace Photo (optional)" : "Photo"}
            >
